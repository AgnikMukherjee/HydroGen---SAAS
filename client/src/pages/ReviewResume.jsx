  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-row gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e) => setInput(e.target.files[0])} type="file" accept='application/pdf' required className='w-full p-2 px-2 mt-2 outline-none border border-gray-300 rounded-md text-gray-600' />

        <p className='font-xs text-gray-500 font-light mt-1'>Supports pdf format only</p>
      ...
      {/* col 2 */}
      <div className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 flex flex-col min-h-75 max-h-[600px]'>
        <div className='flex items-center gap-3'>
