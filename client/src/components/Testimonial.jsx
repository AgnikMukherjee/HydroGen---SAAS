const Testimonial = () => {
    ...
    const testimonialLines = [
        "HyroGen completely changed the way I create content. What used to take hours now takes minutes!",

        "It’s like having a personal content strategist in my pocket. HyroGen is insanely smart.",

        "From blog titles to full articles, HyroGen delivers better than most human writers I’ve worked with.",

        "HyroGen feels like my creative partner. It understands my tone, my style — everything.",

        "SEO-optimized, engaging, and fast — HyroGen is the best AI tool I’ve used hands down.",

        "I literally planned an entire content calendar with HyroGen in a single afternoon. Unreal.",

        "Even when I’m stuck with writer’s block, HyroGen gives me exactly the spark I need to get started.",

        "The UI is clean, the AI is sharp, and the output is gold. HyroGen is a content creator’s dream."
    ];

    const CreateCard = ({ card }) => {
        const randomLine = testimonialLines[Math.floor(Math.random() * testimonialLines.length)];
        ...
        return (
            <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
                ...
                <p className="text-sm py-4 text-gray-800">{randomLine}</p>
    ...
    return (
        ...
        `}</style>
            ...
            <div className="flex flex-col items-center justify-center">
                <h2 className="text-slate-700 text-[42px] font-semibold">Loved by <span className="text-primary">Content Creators</span></h2>
                <p className="text-center text-gray-600 max-w-lg mx-auto">Don't just take our word for it. Check out what our users have to say about our services. </p>
            </div>
